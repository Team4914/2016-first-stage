...
public class RobotMap {
    ...
    public static CANTalon forkliftWinchCANTalon;
    public static Encoder forkliftWinchQE;
    ...
    public static void init() {
        ...
        forkliftWinchCANTalon = new CANTalon(0);
        LiveWindow.addActuator("Forklift", "Winch CAN Talon", forkliftWinchCANTalon);
        
        forkliftWinchQE = new Encoder(0, 1, false, EncodingType.k4X);
        LiveWindow.addSensor("Forklift", "Winch QE", forkliftWinchQE);
        forkliftWinchQE.setDistancePerPulse(1.0);
        forkliftWinchQE.setPIDSourceType(PIDSourceType.kRate);
