...
public class RobotMap {
    ...
    public static Ultrasonic driveTrainUltra;
    ...
    public static void init() {
        ...
        driveTrainGyro.setSensitivity(1.0);
        driveTrainUltra = new Ultrasonic(0, 1);
