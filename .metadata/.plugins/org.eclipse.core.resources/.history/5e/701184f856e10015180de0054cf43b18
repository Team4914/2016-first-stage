...
public class RobotMap {
    ...
    public static void init() {
        ...
        forkliftWinchSlave = new Talon(7);
        LiveWindow.addActuator("Forklift", "Winch Slave", (Talon) forkliftWinchSlave);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        // forlift winch QE
        forkliftWinchQE.setMaxPeriod(.1);
        forkliftWinchQE.setMinRate(10);
	    forkliftWinchQE.setDistancePerPulse(5);
	    forkliftWinchQE.setReverseDirection(true);
	    forkliftWinchQE.setSamplesToAverage(7);
    }
}
