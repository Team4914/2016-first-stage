...
public class Robot extends IterativeRobot {
	...
	public static String cameraServerName = "cam0";
	

    public final static int camfront = NIVision.IMAQdxOpenCamera("cam0", NIVision.IMAQdxCameraControlMode.CameraControlModeController);
    public final static int camback = NIVision.IMAQdxOpenCamera("cam1", NIVision.IMAQdxCameraControlMode.CameraControlModeController);
	public static int currentCam = camfront;
