...
public class OI {
    ...
    public JoystickButton shooterX;
    ...
    public OI() {
        ...
        shooterRightBumper.whenPressed(new FIREFarSequence());
     ...
     // shooterY.whenPressed(new FLIFTUnlock());
        shooterX = new JoystickButton(shooterJoystick, 3);
        shooterX.whenPressed(new FIREEStop());
      ...
      */
        ...
        driverLeftBumper.whenPressed(new RotateCCW180());
        driverRightBumper = new JoystickButton(driverJoystick, 6);
        driverRightBumper.whenPressed(new RotateCW180());
        driverY = new JoystickButton(driverJoystick, 4);
        driverY.whenPressed(new ToggleCamtoFront());
        driverX = new JoystickButton(driverJoystick, 3);
        driverX.whenPressed(new ToggleCamtoBack());
     ...
     // SmartDashboard.putData("Operate Lift", new OperateLift());
        ...
        SmartDashboard.putData("Toggle Cam to Front", new ToggleCamtoFront());
        SmartDashboard.putData("Toggle Cam to Back", new ToggleCamtoBack());
        ...
        SmartDashboard.putData("FIRE Far Sequence", new FIREFarSequence());
        SmartDashboard.putData("FIRE Close Sequence", new FIRECloseSequence());
        SmartDashboard.putData("FIRE EStop", new FIREEStop());
     ...
     // SmartDashboard.putData("FLIFT Raise to 54", new FLIFTRaiseto54());
        SmartDashboard.putData("AUTO 2 to Goal", new AUTO2toGoal());
        SmartDashboard.putData("AUTO 2 to Goal Ramparts", new AUTO2toGoalRamparts());
        SmartDashboard.putData("AUTO 3 to Goal", new AUTO3toGoal());
        SmartDashboard.putData("AUTO 3 to Goal Ramparts", new AUTO3toGoalRamparts());
        SmartDashboard.putData("AUTO 4 to Goal", new AUTO4toGoal());
        SmartDashboard.putData("AUTO 4 to Goal CDF", new AUTO4toGoalCDF());
        SmartDashboard.putData("AUTO 5 to Goal", new AUTO5toGoal());
        SmartDashboard.putData("AUTO 5 to Goal CDF", new AUTO5toGoalCDF());
        SmartDashboard.putData("DEFENSE Portcullis", new DEFENSEPortcullis());
        SmartDashboard.putData("DEFENSE CDF", new DEFENSECDF());
        SmartDashboard.putData("DEFENSE Moat", new DEFENSEMoat());
        SmartDashboard.putData("DEFENSE Ramparts", new DEFENSERamparts());
        ...
        SmartDashboard.putData("DEFENSE Rock Wall", new DEFENSERockWall());
        SmartDashboard.putData("DEFENSE Rough Terrain", new DEFENSERoughTerrain());
    ...
    public double getShooterJoystickLeft() { return driverJoystick.getRawAxis(1); }
    public double getShooterJoystickRight() { return driverJoystick.getRawAxis(5); }
