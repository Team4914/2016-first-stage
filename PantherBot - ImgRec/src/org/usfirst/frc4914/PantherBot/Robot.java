...
import org.usfirst.frc4914.PantherBot.commands.AutonomousCommand;
import org.usfirst.frc4914.PantherBot.commands.DEFENSEBD;
import org.usfirst.frc4914.PantherBot.commands.FIREHighGoal;
import org.usfirst.frc4914.PantherBot.subsystems.DriveTrain;
...
public class Robot extends IterativeRobot {
    ...
    AxisCamera camera = new AxisCamera("10.49.14.11");
    Image frame;
    Image binaryFrame;
	...
	NIVision.Range GOAL_VAL_RANGE = new NIVision.Range(91, 255);
    	...
    	double initialBearing = Robot.driveTrain.getGyroBearing();
     	...
     	finalBearing %= 360;
       	...
       	while (!(Robot.driveTrain.getGyroBearing() > finalBearing - Robot.driveTrain.ANGLE_EPSILON && 
 	      	...
 	      	processImage();
 	      	if (isCentered()) { new FIREHighGoal(); return; }
       	}
