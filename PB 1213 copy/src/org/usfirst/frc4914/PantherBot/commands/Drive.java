...
public class Drive extends Command {
    ...
    protected void execute() {
    	boolean justFinishedTheIntakeSequence = false;
    	/*
    	...
    	if (Robot.oi.isShooterJoystickLeftTriggerPressed()) {
        	...
        	justFinishedTheIntakeSequence = true;
    	}
    	else if (!Robot.oi.isShooterJoystickLeftTriggerPressed()) {
    		// new FIREIntakeSequence();
    		Robot.shooter.stopIntake();
    		justFinishedTheIntakeSequence = false;
    	}
    	...
    	// System.out.println("Right QE: " + Robot.oi.isShooterJoystickLeftTriggerPressed());
    	// System.out.println("Left QE: " + Robot.oi.isShooterJoystickRightTriggerPressed());
    }
