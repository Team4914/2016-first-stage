...
import org.usfirst.frc4914.GRTBot.subsystems.*;
...
public class OI {
    ...
    public OI() {
        ...
        codriverThumb = new JoystickButton(codriverJoystick, 2);
        codriverThumb.whileHeld(new Intake());
        codriverTrigger = new JoystickButton(codriverJoystick, 1);
        codriverTrigger.whenPressed(new ShootLow());
        driverJoystick = new Joystick(0);
        
        driverY = new JoystickButton(driverJoystick, 4);
        driverY.whenPressed(new Turn(true, 180));
        driverA = new JoystickButton(driverJoystick, 1);
        driverA.whenPressed(new InvertDrive());
        driverRightBumper = new JoystickButton(driverJoystick, 6);
        driverRightBumper.whileHeld(new Intake());
        ...
        SmartDashboard.putData("Shoot Low", new ShootLow());
        SmartDashboard.putData("Shoot High", new ShootHigh());
        SmartDashboard.putData("Intake", new Intake());
        SmartDashboard.putData("Move To Scoring Position", new MoveToScoringPosition());
    ...
    public double codriverX() { return codriverJoystick.getRawAxis(0); }
    public double codriverY() { return codriverJoystick.getRawAxis(1); }
    public double codriverZ() { return codriverJoystick.getRawAxis(2); }
}
